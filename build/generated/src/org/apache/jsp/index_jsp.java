...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                                    <input type=\"file\"  required name=\"musicfile\" id=\"musicfile\" class=\"custom-file-input\" onchange=\"setFilename(this)\"/>\n");
      ...
      out.write("                                                    <input type=\"text\" class=\"form-control\" placeholder=\"Key\" aria-label=\"Recipient's username\" aria-describedby=\"basic-addon2\" name=\"key\" id=\"key\" onchange=\"validateKey()\" required>\n");
      out.write("                                                </div>\n");
      ...
      out.write("                                                    </select>\n");
      out.write("                                                    <!-- Action -->\n");
      out.write("                                                    <select class=\"form-control col col-lg-3 col-xl-3 button-padding btn-outline-primary\" id=\"algorithmSel\" onchange=\"setAction()\">\n");
      ...
      out.write("                                                <input type=\"text\" class=\"form-control col-lg-6 col-xl-6 col-sm-12 col-12 no-rounded\" placeholder=\"New Filename\" name=\"newFilename\" id=\"newFilename\" required>                                                           \n");
      out.write("                                                <!--submit button-->\n");
      out.write("                                                <button type=\"submit\" class=\"btn btn-success col-lg-4 col-xl-4 col-sm-12 col-12 no-rounded\" name=\"upload\" id=\"upload\">Go!</button>                                                                                                                                   \n");
      out.write("                                                </div>\n");
      out.write("                                        </form>  \n");
      out.write("                                    </div>    \n");
      out.write("                                    <!-- column 2 -->\n");
      ...
      out.write("                                        </div>\n");
      out.write("                                        <div class=\"row justify-content-center button-padding\">\n");
      out.write("                                            <i class=\"far fa-file fa-8x\" style=\"margin-right: 5%;margin-top: 8.3%;\"></i>\n");
      out.write("                                        </div>\n");
      out.write("                                        <h5><span class=\"badge badge-outline-primary col align-self-center\"></span></h5>\n");
      out.write("                                        <form name=\"donwload\" method=\"get\" action=\"DownloadFileServlet\">\n");
      out.write("                                            <!--checks if there's some file to download-->\n");
      out.write("                                            <div class=\"row justify-content-center button-padding\">                                      \n");
      out.write("                                                <button type=\"submit\" class=\"btn btn-success col-lg-6 col-xl-6 col-sm-6 col-6\" onclick=\"download()\" disabled id=\"download\" name=\"download\"><i class=\"fas fa-download\"></i> Download File</button>                                                                                       \n");
      out.write("                                            </div>\n");
      out.write("\n");
      out.write("                                        </form>    \n");
      out.write("                                    </div>\n");
